...
public class SpigotSkullTextureHandler_v1_20 extends AbstractSkullTextureHandler {
    ...
    public void applyTexture(SkullMeta skullMeta, String textureUrl) {
        ...
        try {
            ...
            ConsoleLogger.error("baselibrary", "Failed to apply texture to skull, reason: %s", e.getMessage());
    ...
    public String getTexture(SkullMeta skullMeta) {
        try {
            ...
            ConsoleLogger.error("baselibrary", "Failed to retrieve texture from skull, reason: %s", e.getMessage());
            return null;
        }
    }
}
